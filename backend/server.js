...
if (!process.env.CLIENT_URL) {
  console.warn(
    'WARNING: CLIENT_URL is not set — defaulting CORS to http://localhost:5173. Set CLIENT_URL explicitly in production.'
  );
}
...
app.get('/api/health', (req, res) =>
  res.json({
    success: true,
    message: 'OS Group API is running',
  })
);
...
app.listen(PORT, () => {
  console.log(
    `OS Group API server running in ${
